...
const current = (data) => {
  ...
  const cityElem = document.getElementById('place'); // Changed ID to cityName
  ...
  if (data.cod === 200) {
    ...
    const temperature = Math.round(data.main.temp - 273.15); // Assuming 'main' contains temperature data
